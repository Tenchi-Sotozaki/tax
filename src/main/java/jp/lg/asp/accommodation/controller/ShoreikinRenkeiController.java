...
@Controller
@RequestMapping("/shoreikinRenkei")
@RequiredArgsConstructor
public class ShoreikinRenkeiController {

    private final ScreenAccessChecker accessChecker;
    private final ShoreikinRenkeiService shoreikinRenkeiService;

    @Value("${app.jichitai.code:00000}")
    ...
    public ResponseEntity<byte[]> downloadCsv(@RequestBody List<ShoreikinRenkeiDto.Key> keys) {
        ...
        String[] csvHeaders = { "宛名番号", "奨励金年度", "納入税額", "交付率", "交付額", "交付年月日", 
        ...
        httpHeaders.setContentDisposition(ContentDisposition.attachment().filename("shoreikin_renkei.csv").build());
    ...
    public String kakunin(@RequestParam("keysJson") String keysJson, Model model) {
        ...
        try {
            ...
            return "renkei/shoreikinRenkeiKakunin";
        } catch (Exception e) {

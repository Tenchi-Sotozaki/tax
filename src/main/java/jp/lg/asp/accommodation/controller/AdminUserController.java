...
public class AdminUserController {
    ...
    public String register(
            @Validated(UserForm.OnCreate.class)
        ...
        if (bindingResult.hasErrors()) {
            ...
            model.addAttribute(
                    "validationErrors",
                    UserForm.validate(form, true).values());

            return FORM_VIEW;
        }

        if (adminUserService.existsActiveUser(form.getId())) {
        ...
        adminUserService.register(form);
    ...
    public String showEditForm(
        ...
        model.addAttribute(
                "isDefaultUser",
                InitialPasswordController.ADMIN_ID.equals(
                        user.getId()));
    ...
    public String update(
            @PathVariable String id,
            @Validated(UserForm.OnUpdate.class)
            @ModelAttribute("userForm") UserForm form,
            BindingResult bindingResult,
            Model model,
            RedirectAttributes redirectAttributes) {
        ...
        if (bindingResult.hasErrors()) {
            ...
            model.addAttribute(
                    "validationErrors",
                    UserForm.validate(form, false).values());

            return FORM_VIEW;
        }

        adminUserService.update(id, form);
    ...
    public String delete(
        ...
        if (adminUserService.isLoginUser(id)) {
    ...
    private UserForm createForm(User user) {

...
function generatePdf() {
    ...
    form.action = '/accommodation-tax/reports/tokugimuJuriTsuchi/pdf';
    form.target = '_self';
    form.submit();
}
...
function preview() {
    ...
    fetch('/accommodation-tax/reports/tokugimuJuriTsuchi/preview', {
        method: 'POST',
...
function print() {
    ...
    fetch('/accommodation-tax/reports/tokugimuJuriTsuchi/print', {
        method: 'POST',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        body: formData
    })

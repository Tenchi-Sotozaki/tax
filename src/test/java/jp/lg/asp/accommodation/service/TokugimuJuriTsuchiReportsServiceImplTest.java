...
/**
 * 特別徴収義務者申請受理通知書 PDF生成（ACCOMMODATION_TAX-349）の単体テスト。
 *
...
class TokugimuJuriTsuchiReportsServiceImplTest {
    ...
    /** 全項目を埋めた入力 */
    private TokugimuJuriTsuchiDto fullDto() {
        ...
        dto.setTokuJushoWithoutYubin("札幌市中央区北1条西1丁目");
    ...
    void generateTsuchiPdf_全項目nullでも例外にならずPDFが生成される() {
        assertPdf(service.generateTsuchiPdf(new TokugimuJuriTsuchiDto()));
    }

    @Test
    void generateTsuchiPdf_公印が空配列でも例外にならずPDFが生成される() {
        TokugimuJuriTsuchiDto dto = fullDto();

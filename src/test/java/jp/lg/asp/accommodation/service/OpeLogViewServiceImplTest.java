...
class OpeLogViewServiceImplTest {
    ...
    void search_mapsLogToDto() {
        ...
        when(operationLogRepository.findByConditions(eq(JICHITAI_CD), any(), any(), any(), any(), any(), any()))
    ...
    void search_unknownScreenId_fallsBackToId() {
        ...
        when(operationLogRepository.findByConditions(any(), any(), any(), any(), any(), any(), any()))
                .thenReturn(List.of(log));
